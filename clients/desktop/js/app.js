...
function animPiece(movePos, done) {
    ...
    var movePiece = new TWEEN.Tween(coords).to(destSquare.renderPos, 500).easing(new Tween.Easing.Quartic()).start().onComplete(done);
...
}).call(this,require("rH1JPG"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_cfca87eb.js","/")
